 ...
 */
- (void)profileConnection:(RTKProfileConnection *)connection didUpdateActiveStatusWithError:(nullable NSError *)error;
 ...
 */
- (void)deviceDidDisconnectWithError:(nullable NSError *)error;
 ...
 */
- (void)sendMessageData:(NSData *)data withCompletionHandler:(void(^)(BOOL success, NSError *_Nullable error))handler;
