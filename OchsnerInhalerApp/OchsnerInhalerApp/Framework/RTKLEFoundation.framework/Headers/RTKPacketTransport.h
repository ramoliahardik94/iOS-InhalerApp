...
/**
 * A block to call when a transport finishes packet sending.
 *
...
/**
 * A block to call when a transport finishes request sending.
 *
 * @param success Indicates whether send is successful or unsuccessful.
 * @param error A nullable object that capsulates failure cause.
...
/**
 * Values that indicates the transport state.
 */
