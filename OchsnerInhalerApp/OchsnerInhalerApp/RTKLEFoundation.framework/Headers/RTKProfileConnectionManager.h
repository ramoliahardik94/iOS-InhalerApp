 ...
 */
- (instancetype)initWithDelegate:(id <RTKProfileConnectionManagerDelegate>)delegate;
 ...
 */
- (void)waitForDeviceBeConnectedOf:(RTKProfileConnection *)connection timeout:(NSTimeInterval)interval completionHandler:(RTKLECompletionBlock)handler;
 ...
 */
- (void)waitForDeviceBeDisconnectedOf:(RTKProfileConnection *)connection timeout:(NSTimeInterval)interval completionHandler:(RTKLECompletionBlock)handler;
