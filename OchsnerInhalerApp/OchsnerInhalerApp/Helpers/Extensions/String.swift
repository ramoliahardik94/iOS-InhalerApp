...
extension String {
    ...
    func withBoldText(text: String, font: UIFont? = nil) -> NSAttributedString {
        let fontObj = font ?? UIFont.systemFont(ofSize: 14, weight: .regular)
        let fullString = NSMutableAttributedString(string: self)
        let boldFontAttribute: [NSAttributedString.Key: Any] = [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: fontObj.pointSize)]
